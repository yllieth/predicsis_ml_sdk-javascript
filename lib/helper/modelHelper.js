    ...
    this.learn = function(project) {
      ...
      return Datasets.getChildren(project.learning_dataset_id)
        ...
        .then(function(classifier) {
          ...
          var requestedReports = [ Reports.createUnivariateSupervisedReport(project) ];

          if (project.main_modality !== null) {
            requestedReports.push(Reports.createTrainClassifierEvaluationReport(project));
            requestedReports.push(Reports.createTestClassifierEvaluationReport(project));
          }
