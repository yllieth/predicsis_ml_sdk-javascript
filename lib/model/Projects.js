 ...
 * </pre>
 *
 * See {@link MLStudio.helper:projectsHelper projects helper} to get the following methods:
 * <ul>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_isModelDone isModelDone(Projects project)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_isDictionaryVerified isDictionaryVerified(Projects project)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_getCurrentState getCurrentState(Projects project)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_getCurrentStep getCurrentStep(String currentView)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_getStateFromStep getStateFromStep(Projects project, String toStep)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_addLearningDataset addLearningDataset(Projects project, String datasetId)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_addScoringDataset addScoringDataset(Projects project, String datasetId)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_addScoreset addScoreset(Projects project, String datasetId)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_resetDictionary resetDictionary(String projectId)}</code></li>
 *   <li><code>{@link MLStudio.helper:projectsHelper#methods_removeDependencies removeDependencies(String projectId)}</code></li>
 * </ul>
 */
angular.module('API.model')
  .service('Projects', function($q, apiRestangular) {
     ...
     *  <b>Important:</b> {@link MLStudio.helper:projectsHelper#methods_removeDependencies Remove project's dependencies}
