NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "type": "service",
      "moduleName": "predicsis.jsSDK",
      "keywords": "$injector addlearningdataset adds addscoreset addscoringdataset api array attached badge change check checked class classifier_id create current dataset datasetid delete description dictionaries dictionary dictionary_id entry forces function generated isdictionaryverified ismodeldone jssdk learning linked model parameter patch predicsis prior project projectid projects projectshelper promise properties property remove removedependencies removes resetdictionary resources scenario score service set simply steps store tells unused update updated user variable"
    },
    {
      "section": "api",
