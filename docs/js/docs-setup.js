NG_DOCS={
  ...
  "pages": [
    {
      "section": "api",
      "id": "predicsis.jsSDK.helpers.uploadHelper",
    ...
    },
    {
      ...
      "keywords": "$q amazon amazonaws api async aws_access_key_id badge changes class colspan create created_at creation credentials csv datafile database dataset dataset_ids delete description destroy documentation encoded_policy encoded_signature example expires_at fetch file filename function generated getcredentials going hello http https identifier jssdk key kml-api list methods_all methods_create methods_delete methods_get methods_update models object output parameters params patch path permanently persist policy post predicsis predicsis_aws_access_key_id public remove removed representation request required resource restangular s3 s3-us-west-2 s3_endpoint send service services signature single size source sourceid sources storage storageservice time type update updated updated_at upload uploaded uploads url user_id"
    },
    {
      "section": "api",
