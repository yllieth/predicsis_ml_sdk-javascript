...
angular
  ...
  .service('uploadHelper', function($rootScope, $injector) {
     ...
     * @param {Number} chunkSize size of each part in Bytes
     */
    this.processFile = function(file, chunkSize) {
      chunkSize = chunkSize || 50 * 1024 * 1024;
      var uploadId = new Date().getTime() + '_' + (file.name || '');
      var uploadRes = upload(file, chunkSize);
